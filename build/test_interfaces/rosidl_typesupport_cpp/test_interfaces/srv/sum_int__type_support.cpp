...
static const _SumInt_Request_type_support_symbol_names_t _SumInt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, srv, SumInt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces, srv, SumInt_Request)),
  }
};
...
{
  return &::test_interfaces::srv::rosidl_typesupport_cpp::SumInt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_interfaces, srv, SumInt_Request)() {
  return get_message_type_support_handle<test_interfaces::srv::SumInt_Request>();
}
...
static const _SumInt_Response_type_support_symbol_names_t _SumInt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, srv, SumInt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces, srv, SumInt_Response)),
  }
};
...
{
  return &::test_interfaces::srv::rosidl_typesupport_cpp::SumInt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_interfaces, srv, SumInt_Response)() {
  return get_message_type_support_handle<test_interfaces::srv::SumInt_Response>();
}
...
static const _SumInt_type_support_symbol_names_t _SumInt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces, srv, SumInt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces, srv, SumInt)),
  }
};
...
{
  return &::test_interfaces::srv::rosidl_typesupport_cpp::SumInt_service_type_support_handle;
}
